...
export default function Summary() {
  ...
  return (
    <div className="container">
      ...
      <p>
        Welcome to TextKit! This app allows you to input text manually or upload
        documents (PDF/DOCX) for AI summarization.
      </p>
      ...
      <footer className="mt-12 pt-6 border-t border-gray-200">
        <div className="text-center text-sm text-gray-500">
          <p>
            Text Summarizer v1.0 | Powered by Google Generative AI and
            HuggingFace
          </p>
          <p className="mt-1">
